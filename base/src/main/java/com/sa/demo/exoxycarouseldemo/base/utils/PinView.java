...
public class PinView extends AppCompatEditText {
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.SFPinView, defStyleAttr, 0);

        mViewType = a.getInt(R.styleable.SFPinView_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.SFPinView_itemCount, DEFAULT_COUNT);
        mPinItemSize = a.getDimensionPixelSize(R.styleable.SFPinView_itemSize,
                res.getDimensionPixelOffset(R.dimen.pin_view_item_size));
        mPinItemHeight = mPinItemWidth = mPinItemSize;
        if (a.hasValue(R.styleable.SFPinView_itemHeight)) {
            mPinItemHeight = a.getDimensionPixelOffset(R.styleable.SFPinView_itemHeight,
                    res.getDimensionPixelOffset(R.dimen.pin_view_item_size));
        }
        if (a.hasValue(R.styleable.SFPinView_itemWidth)) {
            mPinItemWidth = a.getDimensionPixelOffset(R.styleable.SFPinView_itemWidth,
                    res.getDimensionPixelOffset(R.dimen.pin_view_item_size));
        }
        mPinItemSpacing = a.getDimensionPixelOffset(R.styleable.SFPinView_itemSpacing,
                res.getDimensionPixelOffset(R.dimen.pin_view_item_spacing));
        mPinItemRadius = a.getDimensionPixelOffset(R.styleable.SFPinView_itemRadius,
                res.getDimensionPixelOffset(R.dimen.pin_view_item_radius));
        mLineWidth = a.getDimensionPixelOffset(R.styleable.SFPinView_borderWidth,
                res.getDimensionPixelOffset(R.dimen.pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.SFPinView_borderColor);
        if (a.hasValue(R.styleable.SFPinView_lineWidth)) {
            mLineWidth = a.getDimensionPixelOffset(R.styleable.SFPinView_lineWidth,
                    res.getDimensionPixelOffset(R.dimen.pin_view_item_line_width));
        }
        if (a.hasValue(R.styleable.SFPinView_lineColor)) {
            mLineColor = a.getColorStateList(R.styleable.SFPinView_lineColor);
            if (mLineColor != null) mCurLineColor = mLineColor.getColorForState(getDrawableState(), ContextCompat.getColor(context, R.color.colorPrimaryDark));
        }
    ...
    private void updateColors() {
        ...
        int color;
        if (mLineColor != null) {
            color = mLineColor.getColorForState(getDrawableState(), ContextCompat.getColor(getContext(), R.color.colorPrimaryDark));
        } else {
